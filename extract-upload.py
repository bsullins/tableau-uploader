...
sourcedir = 'c:\\wamp\\www\\tableau-uploader\\uploads\\' # need to double up the \\s | windows shares use like this '\\\\ryrobesxps\d$\' etc
targetdir = 'c:\\wamp\\www\\tableau-uploader\\uploads\\' # can't be a share or UNC path
